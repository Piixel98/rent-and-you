...
import {
  ...
  VehicleReadModel,
  OfficeReadModel,
  UserReadModel, RgpdService, RGPDCreateModel, AuthService,
} from '../client';
          ...
          <Box borderWidth="1px" borderRadius="lg" p={5}>
            <form onSubmit={handleUserSubmit(handleUserFormSubmit)}>
              <VStack spacing={4} align="stretch">
                  ...
                  <>
                    ...
                    <HStack spacing={4}>
                      <FormControl id="email">
                        ...
                        <Input defaultValue={user?.email?.toLowerCase() || ''} {...userRegister('email')} required type="email" />
                      </FormControl>
                ...
                <FormControl id="total">
                  {loading ? (
                    ...
                    <Input
                      type="text"
                      readOnly
                      value={vehicle && vehicle.price_per_day && total_days
                          ? `${vehicle.price_per_day * parseInt(total_days)} €`
                          : ''}
                    />
                  ) : (
                ...
                <Button colorScheme="green" mt={4} type="submit" isDisabled={!isUserFormValid}>
                  ¡Reservar ahora!
                </Button>
              </VStack>
            </form>
