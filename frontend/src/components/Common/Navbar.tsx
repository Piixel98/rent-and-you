...
const NAV_ITEMS: Array<NavItem> = [
  {
    label: 'Alquilar un vehículo',
    children: [
      {
        label: 'Alquiler de coches',
        subLabel: 'Escoge tu coche ideal',
        href: '/search',
      },
      {
        label: 'Alquiler de furgonetas',
        subLabel: 'Descubre nuestras furgonetas',
        href: '/search',
      },
    ],
  },
  {
    ...
    children: [
      {
        label: 'Promociones semanales',
        subLabel: 'Por tiempo limitado!',
        href: '/search',
      },
      {
        label: 'Ofertas y promociones',
        subLabel: 'Aprovecha nuestras ofertas',
        href: '/search',
      },
    ],
  },
