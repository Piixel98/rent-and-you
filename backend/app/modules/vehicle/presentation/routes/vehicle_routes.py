...
router.include_router(
    create_vehicle_route, dependencies=[Depends(get_current_active_admin)]
)
router.include_router(
    delete_vehicle_route, dependencies=[Depends(get_current_active_admin)]
)
router.include_router(get_vehicle_route)
router.include_router(get_vehicles_route)
router.include_router(
    update_vehicle_route, dependencies=[Depends(get_current_active_admin)]
)
